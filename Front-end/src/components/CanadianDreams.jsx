    ...
    return (
        <div className='grid lg:grid-cols-2 gap-2 md:gap-0 lg:py-20 py-8  px-5 md:px-10 lg:px-0 container mx-auto '>
            ...
            <div className='lg:ml-8 xl:ml-0 overflow-hidden'>
                ...
                <p className='xl:w-5/6 lg:mb-6  mt-3 text-base sm:text-xl xl:mr-12 mr-8'>At Canadian Dreams Immigration, we’re a federally licensed consultancy based in Brampton, Ontario, with a branch in Surrey, BC. We guide students, skilled professionals, entrepreneurs, and families every step of the way to make their Canadian dreams a reality — reliably, transparently, and professionally.</p>
                <Link
                    to="/contact-us"
