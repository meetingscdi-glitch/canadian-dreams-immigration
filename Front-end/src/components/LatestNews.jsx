...
const LatestNews = () => {
  ...
  return (
    <div className="py-12 bg-[#F4FBFF] relative md:px-14 xl:px-32 mb-14 md:mt-12">
          ...
          >
            {news.map((t, index) => (
              <SwiperSlide key={index}>
                <div className=" p-6 rounded-lg shadow-md h-full md:min-h-[30rem] flex flex-col bg-white">
                  <div className="flex flex-col gap-3">
                    <img src={t.image} alt="NewsImage" className="h-64 object-cover" />
                    <div>
                      <h1 className="text-2xl font-medium">{t.heading}</h1>
                      <h3 className="text-lg mt-4">{t.paragraph}</h3>
                    </div>
                  </div>
      ...
      <div className="relative bg-[#F4FBFF] pb-16 md:pb-0">
          <button
          ref={prevRef}
        ...
        <div className="custom-pagination hidden md:flex gap-2 justify-center mt-8"></div>
      </div>
