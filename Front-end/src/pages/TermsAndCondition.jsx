                ...
                <div className='flex flex-col gap-12'>
                    ...
                    <FadeInOnScroll>
                        <div>
                            ...
                            <h4 className='text-base md:text-xl mt-3 text-[#2D2B2B]'>
                                Canadian Immigration offers immigration-related consulting, documentation assistance, and application support for individuals seeking to study, work, visit, or settle abroad.
                            </h4>
                            <h4 className='text-base md:text-lg mt-4 text-[#2D2B2B] leading-6'>
                                Our services are limited to advisory and application support. We do not guarantee visa approval, as final decisions are made solely by immigration authorities.
                            </h4>
                        </div>
                    </FadeInOnScroll>
                    ...
                    <FadeInOnScroll>
                        <div>
                            ...
                            <h4 className='text-lg  text-[#2D2B2B] mt-4'>
                                We are not responsible for delays or denials caused by incomplete, incorrect, or false information provided by the client.
                            </h4>
                        </div>
                    </FadeInOnScroll>
                    ...
                    <FadeInOnScroll>
                        <div>
                            ...
                            <h4 className='text-base md:text-lg mt-3 text-[#2D2B2B] leading-6'>
                                All service fees are discussed and agreed upon before work begins. Fees once paid are non-refundable, unless explicitly stated in a written agreement.
                                Government fees, courier charges, and other third-party costs are not included in our service fees unless specified.
                            </h4>
                        </div>
                    </FadeInOnScroll>
                    ...
                    <FadeInOnScroll>
                        <div>
                            ...
                            <h4 className='text-base md:text-lg mt-3 text-[#2D2B2B]'>
                                We maintain strict confidentiality of all client data and documents. However, we may disclose information if legally required by law enforcement or immigration authorities.
                            </h4>
                        </div>
                    </FadeInOnScroll>
                    ...
                    <FadeInOnScroll>
                        <div>
                            ...
                            <h4 className='text-base md:text-lg mt-3 text-[#2D2B2B] leading-6'>
                                All content on our website, including text, images, and logos, is the intellectual property of Canadian Immigration.
                    ...
                    <FadeInOnScroll>
                        <div>
                            ...
                            <h4 className='text-base md:text-lg mt-3 text-[#2D2B2B] leading-6'>
                                These Terms shall be governed and interpreted in accordance with the laws of [Your State/Country].
                                Any disputes shall be subject to the exclusive jurisdiction of the courts located in [Your Location].
                            </h4>
                        </div>
                    </FadeInOnScroll>
